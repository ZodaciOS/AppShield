...
class AppUI:
    def __init__(self):
        ...
        ttk.Label(left_frame, text="Findings", font=self.default_font_bold, style="TLabel").pack(anchor="w", pady=(0, 5))
    ...
    def setup_font_and_style(self):
        ...
        style.configure("TNotebook.Tab", background=INACTIVE_BG, foreground=INACTIVE_FG, padding=(12, 6), font=(self.default_font_name, default_size))
